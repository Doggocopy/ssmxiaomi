...
<body style=" background-color: #EDEDED; font-family: 黑体; ">
			...
			<c:forEach items="${carlist}" var="car">
				...
				<tr style="font-size: 18px;">
					<td width="300" height="150">
						...
						<a href="${(pageContext.request.contextPath)}/fore/product?flag=one&pid=${car.prod.pId}"><img alt="" src="${pageContext.request.contextPath}/image_big/${car.prod.pImage}" style="height: 150;"></a>
					</td>
					<td width="100">
						${car.prod.pName}</td>
					<td width="400">
						${car.prod.pContent}</td>
					<td width="100">${car.prod.pPrice }</td>
					<td width="210">
						<c:if test="${car.numbers>1 }">
						<a href="javascript:changeN(${car.cid},${car.numbers-1})">-</a>
						</c:if>
						<c:if test="${car.numbers==1 }">
						-
						</c:if>
					...
					<td width="200" style="color: #FF7E00;">${car.prod.pPrice*car.numbers }元</td>
	...
	<script type="text/javascript">
		function changeN(cid,num) {
			...
			$.ajax({
				type : "post",
				url : "${pageContext.request.contextPath}/fore/changeNumber.action",
	...
	<div id="jiesuan">
		<div id="jiesuan_left">
			<a href="${pageContext.request.contextPath}/index.jsp" style="display: block; width: 150px; height: 50px; line-height: 50px; background-color: #FF7E00; font-size: 20; text-align: center;"
		...
		<div id="jiesuan_right">
			...
			<div style="position: absolute;margin-left: 350px; margin-top: -45px;">
				<a href="${pageContext.request.contextPath}/fore/showAddress.action" style="margin-top:25px ;display: block; width: 200px; height: 50px; line-height: 50px; background-color: #FF7E00; font-size: 26; text-align: center;"
					onmouseover="this.style.color='white';"
					onmouseout="this.style.color='black';">
					去结算 </a>
			</div>
